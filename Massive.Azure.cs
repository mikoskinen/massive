...
namespace Massive
{
    ...
    public class DynamicModel : DynamicObject
    {
        ...
        public virtual IEnumerable<dynamic> Query(string sql, params object[] args)
        {
            ...
            {
                var rdr = CreateCommand(sql, conn, args).ExecuteReaderWithRetry();
                while (rdr.Read())
                {
        ...
        public virtual IEnumerable<dynamic> Query(string sql, ReliableSqlConnection connection, params object[] args)
        {
        ...
        /// </summary>
        SqlCommand CreateCommand(string sql, ReliableSqlConnection conn, params object[] args)
        {
        ...
        /// </summary>
        public virtual ReliableSqlConnection OpenConnection()
        {
            var result = new ReliableSqlConnection(ConnectionString, policy);
        ...
        {
            return Execute(new SqlCommand[] { command });
        }
        ...
        /// <summary>
        /// Executes a series of SqlCommands in a transaction
        /// </summary>
        ...
        private RetryPolicy<SqlAzureTransientErrorDetectionStrategy> policy;
